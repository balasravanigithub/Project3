...
#Main Screen
master=Tk()
master.title("Mail Allication using GUI")
...
def send():
    try:
        ...
        notif.config(text='Email send successfully',fg='green')
...
#Graphics
Label(master, text="Mail Application App",font=('calibri',15)).grid(row=0,sticky=N)
